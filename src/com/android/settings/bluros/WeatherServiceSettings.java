...
import bluros.weatherservice.WeatherProviderService;
...
import static org.bluros.internal.logging.CMMetricsLogger.WEATHER_SETTINGS;
    ...
    private void updateAdapter() {
        ...
        for (ResolveInfo resolveInfo : resolveInfoList) {
            ...
            if (!resolveInfo.serviceInfo.permission.equals(
                    bluros.platform.Manifest.permission.BIND_WEATHER_PROVIDER_SERVICE)) {
                continue;
            }
