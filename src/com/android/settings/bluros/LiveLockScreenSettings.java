...
import bluros.app.LiveLockScreenManager;
import bluros.externalviews.KeyguardExternalViewProviderService;
...
import static bluros.providers.CMSettings.Secure.LIVE_LOCK_SCREEN_ENABLED;
...
public class LiveLockScreenSettings extends SettingsPreferenceFragment implements
    ...
    public static class LiveLockScreenBackend {
        ...
        public void setActiveLiveLockScreen(ComponentName liveLockScreen) {
            ...
            bluros.app.LiveLockScreenInfo.Builder builder =
                    new bluros.app.LiveLockScreenInfo.Builder();
        ...
        public ComponentName getActiveLiveLockScreen() {
            bluros.app.LiveLockScreenInfo llsInfo = mLLSM.getDefaultLiveLockScreen();
